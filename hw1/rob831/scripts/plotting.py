...
plt.errorbar(df_means['Step'], df_means['Value'], yerr=df_std_dev['Value'], fmt='-o', label='DAgger Policy')
...
plt.axhline(y=BC_AGENT_PERFORMANCE, color='g', linestyle='-', label='Behavioral Cloning Agent')
